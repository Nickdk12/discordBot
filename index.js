...
const token = 'NjQ3MTAxMTk1NjIxNDk4OTIw.Xdax-w.xGJ0kRhi-Brt50IWGCfbBC-nYw8';

// NjQ1OTgzNTI5MjYzNjkzODQ1.XdQQWw.hwIOBPgikdBllvLxRqB2xHF1rmQ = Test bot's token
// NjQ3MTAxMTk1NjIxNDk4OTIw.Xdax-w.xGJ0kRhi-Brt50IWGCfbBC-nYw8 = Neosky's token
bot.on('ready', () => {
...
bot.on('message', async message => {
    ...
    switch (args[0]) {
        ...
        case 'clear':
            if (message.member.roles.some(role => role.name === "Hjælper","Mod","Admin","Ejer")) {
                if (!args[1]) {
                    ...
                    console.log('command: !clear', args[1]);
                    break;
                }
            }
        ...
        case 'hjælp':
            if (message.member.roles.some(role => role.name === "Hjælper","Mod","Admin","Ejer")) {
                ...
                const embed = new Discord.RichEmbed()
                    .setTitle('NeoSky Moderation Hjælp', true)
        ...
        case 'forslag':
            if (args[1]) {
                ...
                const embed = new Discord.RichEmbed()
                    ...
                    .setColor(0x5463F3)
                const forslagskanal = bot.channels.get('646794072941527041')
